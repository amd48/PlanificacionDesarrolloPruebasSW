...
public class ClienteDAO implements IClienteDAO
{
    ...
    private final String cadena_conexionDB = "jdbc:mysql://localhost:3306/DBUNIT?serverTimezone=UTC&useSSL=false";
    ...
    public void delete (Cliente cliente) throws SQLException {
        ...
        String sql = "delete from cliente where " +
                "nombre = '" + cliente.getNombre() + "' and " +
                "apellido = '" + cliente.getApellido() + "' and " +
                "direccion = '" + cliente.getDireccion() + "' and " +
